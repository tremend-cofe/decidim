...
module Decidim
  module Assemblies
    ...
    class AssemblyType < Decidim::Api::Types::BaseObject
      ...
      field :subtitle, Decidim::Core::TranslatedFieldInterface, "The subtitle of this assembly", null: true
      field :short_description, Decidim::Core::TranslatedFieldInterface, "The sort description of this assembly", null: true
      field :description, Decidim::Core::TranslatedFieldInterface, "The description of this assembly", null: true
      ...
      field :developer_group, Decidim::Core::TranslatedFieldInterface, "The promoter group of this assembly", null: true
      field :meta_scope, Decidim::Core::TranslatedFieldInterface, "The scope metadata of this assembly", null: true
      field :local_area, Decidim::Core::TranslatedFieldInterface, "The organization area of this assembly", null: true
      field :target, Decidim::Core::TranslatedFieldInterface, "Who participates in this assembly", null: true
      field :participatory_scope, Decidim::Core::TranslatedFieldInterface, "What is decided on this assembly", null: true
      field :participatory_structure, Decidim::Core::TranslatedFieldInterface, "How it is decided on this assembly", null: true
      ...
      field :purpose_of_action, Decidim::Core::TranslatedFieldInterface, "Purpose of action", null: true
      field :composition, Decidim::Core::TranslatedFieldInterface, "Composition of this assembly", null: true
      ...
      field :created_by_other, Decidim::Core::TranslatedFieldInterface, "Custom creator", null: true
      ...
      field :closing_date_reason, Decidim::Core::TranslatedFieldInterface, "Closing date reason of this assembly", null: true
      field :internal_organisation, Decidim::Core::TranslatedFieldInterface, "Internal organisation of this assembly", null: true
      field :is_transparent, Boolean, "If this assembly is transparent", null: true
      field :special_features, Decidim::Core::TranslatedFieldInterface, "Special features of this assembly", null: true
