...
module Decidim
  module Core
    class AmendmentType < Types::BaseObject
      ...
      field :state, String, "The status of this amendment", null: false
      field :amender, Decidim::Core::AuthorInterface, "The author of this amendment", null: false

      field :amendable_type, String, method: :decidim_amendable_type, description: "Type of the amendable object", null: false
      field :emendation_type, String, method: :decidim_emendation_type, description: "Type of the emendation object", null: false
