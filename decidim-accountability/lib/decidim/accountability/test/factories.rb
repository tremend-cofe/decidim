...
FactoryBot.define do
  ...
  factory :status, class: "Decidim::Accountability::Status" do
    ...
    component { association(:accountability_component, skip_injection:) }
  ...
  factory :result, class: "Decidim::Accountability::Result" do
    ...
    end_date { "30/9/2017" }
    status { association :status, component:, skip_injection: }
    progress { rand(1..100) }
  end
  ...
  factory :timeline_entry, class: "Decidim::Accountability::TimelineEntry" do
    ...
    result { association(:result, skip_injection:) }
