    ...
    describe "#present" do
      context "when invite still exists" do
        it "renders the invite information" do
          ...
          space = "<a class=\"logs__log__space\" href=\"/processes/#{participatory_space.slug}?participatory_process_slug=#{participatory_space.slug}\">#{escape_translated(participatory_space.title)}</a>"
