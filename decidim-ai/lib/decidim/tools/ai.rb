...
require "cld"
require "decidim/tools/ai/admin"
require "decidim/tools/ai/engine"
require "decidim/tools/ai/admin_engine"
require "decidim/tools/ai/spam_content"
require "decidim/tools/ai/resource"
require "decidim/tools/ai/overrides"
  ...
  module Tools
    module Ai
      ...
      config_accessor :trained_models do
        %w(
          Decidim::Tools::Ai::Resource::Comment
          Decidim::Tools::Ai::Resource::Meeting
          Decidim::Tools::Ai::Resource::Proposal
          Decidim::Tools::Ai::Resource::CollaborativeDraft
          Decidim::Tools::Ai::Resource::Debate
          Decidim::Tools::Ai::Resource::UserBaseEntity
        )
      end
      ...
      def self.create_reporting_users
        Decidim::Organization.find_each do |organization|
          ...
          user.email = Decidim::Tools::Ai.reporting_user_email
