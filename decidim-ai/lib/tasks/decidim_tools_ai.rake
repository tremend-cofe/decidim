...
namespace :decidim do
  namespace :spam do
    ...
    task reset: :environment do
      Decidim::Tools::Ai::SpamContent::Repository.reset!
    end
    ...
    namespace :train do
      ...
      task :file, [:file] do |_, args|
        Decidim::Tools::Ai::SpamContent::Repository.load_from_file!(Rails.root, args[:file])
      end
    end
    ...
    namespace :data do
      ...
      task create_reporting_user: :environment do
        Decidim::Tools::Ai.create_reporting_user
      end
    end
