    ...
    module Admin
      class StopwordsController < ApplicationController
        ...
        def update
          ...
          @form = form(Decidim::Ai::Admin::StopwordForm).from_params(params)
        ...
        def edit
          ...
          @form = form(Decidim::Ai::Admin::StopwordForm).from_model(word)
        end
        ...
        def new
          enforce_permission_to :create, :stopwords
          @form = form(Decidim::Ai::Admin::StopwordForm).instance
        end
        ...
        def word
          @word ||= Decidim::Ai::StopWord.where(organization: current_organization).find(params[:id])
        end

        def collection
          @collection ||= paginate(Decidim::Ai::StopWord.where(organization: current_organization))
        end
      end
    end
  end
