...
module Decidim
  module Conferences
    ...
    class ConferenceType < Decidim::Api::Types::BaseObject
      ...
      field :short_description, Decidim::Core::TranslatedFieldInterface, "The short description of this conference", null: true
      field :description, Decidim::Core::TranslatedFieldInterface, "The description of this conference", null: true
      field :slug, String, "The slug of this conference", null: true
      field :hashtag, String, "The hashtag for this conference", null: true
      field :slogan, Decidim::Core::TranslatedFieldInterface, "The slogan of the conference", null: true
      ...
      field :objectives, Decidim::Core::TranslatedFieldInterface, "The objectives of the conference", null: true
      ...
      field :registration_terms, Decidim::Core::TranslatedFieldInterface, "The registration terms of this conference", null: true
