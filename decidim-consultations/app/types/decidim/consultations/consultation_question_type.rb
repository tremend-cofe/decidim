...
module Decidim
  module Consultations
    ...
    class ConsultationQuestionType < Decidim::Api::Types::BaseObject
      ...
      field :title, Decidim::Core::TranslatedFieldInterface, "Title of the question", null: true
      field :subtitle, Decidim::Core::TranslatedFieldInterface, "The subtitle of this question", null: true
      ...
      field :components, [Decidim::Core::ComponentType, null: true], description: "Lists the components this space contains.", null: true

      def components
        Decidim::Component.where(participatory_space: object).published
      end
      ...
      field :what_is_decided, Decidim::Core::TranslatedFieldInterface, "What is decided in this question", null: true
      field :promoter_group, Decidim::Core::TranslatedFieldInterface, "The promoter group of this question", null: true
      field :participatory_scope, Decidim::Core::TranslatedFieldInterface, "The participatory scope of this question", null: true
      field :question_context, Decidim::Core::TranslatedFieldInterface, "The context for this question", null: true
      ...
      field :origin_scope, Decidim::Core::TranslatedFieldInterface, "The origin scope of this question", null: true
      field :origin_title, Decidim::Core::TranslatedFieldInterface, "The origin title of this question", null: true
      ...
      field :instructions, Decidim::Core::TranslatedFieldInterface, "Instructions for this question", null: true
    end
  end
end
